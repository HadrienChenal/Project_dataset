...
def layout(dataframes: dict):
    """Crée la page d'analyses avec 6 histogrammes."""
    ...
    # Construction du layout avec 6 histogrammes
    return html.Div([
        html.H2('Analyses détaillées', style={'marginTop': '20px', 'textAlign': 'center'}),

        # --- Ligne 1: Scores de base (full width) ---
        html.Div([
            html.Div([
        ...
        # --- Ligne 2: Notes globales + Propreté (side-by-side) ---
        html.Div([
            html.Div([
        ...
        # --- Ligne 3: Confort + Installations + Emplacement (3 columns) ---
        html.Div([
            html.Div([
